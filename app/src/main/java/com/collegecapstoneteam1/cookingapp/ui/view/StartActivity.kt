...
class StartActivity : AppCompatActivity() {
    ...
    private fun setResultSignUp() {
        resultLauncher =
            registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
                ...
                Toast.makeText(this@StartActivity, "${result.resultCode}, ${Activity.RESULT_OK}", Toast.LENGTH_SHORT).show()
                if (result.resultCode == Activity.RESULT_OK) {
                    Toast.makeText(this@StartActivity, "구글 로그인 시도", Toast.LENGTH_SHORT).show()
    ...
    private fun handleSignInResult(completedTask: Task<GoogleSignInAccount>) {
        try {
            ...
            Toast.makeText(this@StartActivity, "구글 로그인", Toast.LENGTH_SHORT).show()
